(function () {
	...
	*/
	...
	// PrimeTube Fire UI builder
	function primeTube_buildUI() {
		if (goodTube_versionConflict) {
			return;
		}
		...
		s.setAttribute('data-version', 'primeTube');
		...
		if (gearBtn) {
			gearBtn.addEventListener('click', (e) => {
				...
				if (modal) {
					...
					if (firstSetting) firstSetting.scrollIntoView({ behavior: 'smooth', block: 'center' });
				}
			});
		}
	}
